...
public class RestClientMembersRestTemplate implements RestClient {
    ...
    public List<GitMember> retrieveAllMembers() {
        ResponseEntity<GitMember[]> gitMemebers = restTemplate.getForEntity("http://localhost:8080/members", GitMember[].class);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(restClientMembersRestTemplate.retrieveAllMembers());
    }
}